(function ( $ ) {
    $.fn.glomexPlayer = function( options ) {
        return this.each(function() {
            ...
            initPlayer();
            function initPlayer(){
                $this.html('<glomex-player data-player-id="2b9h4wtj2ryvj87" data-playlist-id="'+settings.videoId+'" data-width="588" data-height="330"></glomex-player> <div class="videoEl videoTracker" data-track="video"></div> <div class="timelineEl videoTracker" data-track="timeline"></div><div class="timelineBlockEl" data-track="timelineBlock"></div> <div class="controlEl videoTracker" data-track="video"></div><div class="placeholderEl1 videoTracker" data-track="placeholder"></div><div class="placeholderEl2 videoTracker" data-track="palceholder"></div>');
                events();
